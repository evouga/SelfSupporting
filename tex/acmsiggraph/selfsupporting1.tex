...
supporting. (c) Small changes achieve both properties.}
 \label{fig:lilium:pq}\end{minipage}
	\nix{\centerline{\begin{overpic}[width=0.24\textwidth]{fig/cas-vf.jpg}
		\put(0,35){(a)}
	\end{overpic}\relax
...
\medskip
	\begin{overpic}[width=0.48\columnwidth]{fig/cas-vf.jpg}
		%\put(0,35){(a)}
	\end{overpic}\hfill
	\begin{overpic}[width=0.52\columnwidth]{arch-fig/1roo38.jpg}
		%\put(0,35){(a)}
	\end{overpic}
	\caption{Planar quad remeshing of the surface of 
Figure~\protect\ref{fig:cas}. Left: Principal directions.
Right: Interior view of a moment\dash free steel\slash glass
construction based on a self\dash supporting PQ mesh.}
	\label{fig:cas:pq}
  \end{figure}
