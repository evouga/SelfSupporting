...
\begin{figure}[h]
	\includegraphics[width=.40\columnwidth]{fig/load2.jpg}
	\hfill
	\begin{minipage}[b]{.56\columnwidth}
	\caption{This self\dash supporting surface of 
diamger 14\,m is imagined as masonry of thickness 0.1\,m. It still possesses a 
thrust network inside the masonry hull if a 
load of 11.000\,kg (shown in dark) is applied to a certain vertex. This 
means that the surface is still stable after that load is applied.}
\label{fig:load}
\end{minipage}
\end{figure}
