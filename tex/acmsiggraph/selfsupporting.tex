...
\teaser{\centering
        \includegraphics[height=.28\textwidth]{arch-fig/cheesevault78.jpg}
        \includegraphics[height=.28\textwidth]{arch-fig/1roo97}
...
{\em Right:} Curvature analysis with respect to the so\dash called
Airy stress surface
...
model for unspported masonry and the discretization needed in our
algorithms. The connection
...
moment\dash free steel\slash glass constructions. Finally we 
discuss convergence \secref{sec:convergence}.
...
(d).} \protect\label{fig:vault}
 ...
 \begin{figure*}[t]
 \centerline{\includegraphics[width=.2\textwidth]{fig/video1}\relax
...
in \S\protect\ref{sec:special}.  In (b) pillars have been added. Cutting
...
\bigskip
  ...
  \newdimen\tmplen\tmplen=0.095\textwidth
...
\bibliographystyle{acmsiggraph}
	...
	\def\thebibliography#1{\otb{#1}\itemsep-0.2pt}
