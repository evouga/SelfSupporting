...
This section contains the theoretical basis of the paper. \S\ref{ssec:cont}
and \S\ref{sec:thrustnetworks} explain the mathematical
model for unsupported masonry and the discretization needed in our
...
which deals with self\dash supporting PQ (planar quad) meshes and
...
left to right. \newtext{These load tests were inspired by real-world experiments performed by the Block Research Group~\protect\cite{catalan,blockfigs}} } \label{fig:load2}
...
world analogues on his web page at ETH Zurich.~\cite{catalan}
