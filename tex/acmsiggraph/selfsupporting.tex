...
\hfill
%\includegraphics[width=0.3\textwidth]{fig/cas-pq}
%TODO
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.3\columnwidth]{fig/vault}
\hfill
\includegraphics[width=0.3\columnwidth]{fig/vault-flat}
\hfill
\includegraphics[width=0.3\columnwidth]{fig/vault-pq}
