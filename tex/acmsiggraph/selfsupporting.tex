...
\teaser{
	\includegraphics[width=.39\textwidth]{arch-fig/cheesevault78.jpg}\hfill
	\raise.02\textwidth\hbox{\includegraphics[width=.6\textwidth]
		{arch-fig/1roo64.jpg}}
	\vskip-1ex
...
{\em Right:} Curvature analysis with respect to isotropic geometry
...
\end{table}
 ...
 \centerline{\begin{overpic}[width=2.57\tmplen]{fig/remove-1n.jpg}
		\put(0,10){(a)}
	\end{overpic}\hfill
	 \begin{overpic}[width=2.57\tmplen]{fig/remove-2n.jpg}
		\put(0,10){(b)}
	\end{overpic}\hfill
