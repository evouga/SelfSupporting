...
\centerline{\begin{overpic}[width=.24\textwidth]{fig/lilium0.jpg}
		\put(0,0){(a)}
	\end{overpic}\hfill
	\begin{overpic}[width=.24\textwidth]{fig/lilium-n.jpg}
		\put(0,0){(b)}
		\put(20,64){$\SS$}
	\end{overpic}\hfill
	\begin{overpic}[width=.24\textwidth]{fig/lilium-nstress.jpg}
		\put(0,0){(c)}
		\put(25,60){$\Phi$}
		\lput(45,0){$\SS'^*=\Phi'^*$}
	\end{overpic}\hfill
	\begin{overpic}[width=0.24\textwidth]{fig/lilium-pillar-n.jpg}
		\put(0,0){(d)}
	\end{overpic}}
