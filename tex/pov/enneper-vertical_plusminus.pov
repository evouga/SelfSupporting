...
#version 3.6;
#include "enneper/enneper-vertical_definitions.inc" // declare r1,r2, camera, lights, surroundings
...
#declare i=0; #while (i<NV) 
	#declare V[i]=<VM[i].x, VM[i].y-1.05, VM[i].z>;
#declare i=i+1; #end
...
#declare i=0; #while (i<NV) 
	#declare V[i]=<VM[i].x, VK[i].y+((alph/10)*VM[i].y)-3.95, VM[i].z>;
#declare i=i+1; #end
...
#declare i=0; #while (i<NV) 
	#declare V[i]=<VM[i].x, VK[i].y-((alph/10)*VM[i].y)+0.5, VM[i].z>;
#declare i=i+1; #end
...
#declare i=0; #while (i<NV) 
	#declare V[i]=<VK[i].x, VK[i].y-1.9, VK[i].z>;
#declare i=i+1; #end
...
#declare i=0; #while (i<NV)
        ...
        union{         
	        cylinder { <VM[i].x, VK[i].y+((alph/10)*VM[i].y)-3.95, VM[i].z> <VM[i].x, VK[i].y-((alph/10)*VM[i].y)+0.5, VM[i].z> 0.004 }
                rotate -x*90 translate -y*1.5 texture{pigment{color rgbt<0.2,0.2,0.2,0.7>}  }
	}
	#end
#declare i=i+1; #end                                                                                                                       
...
#declare i=0; #while (i<NV)
        #if(i=206|i=191|i=3|i=207|i=39|i=22)
                union{ 
                        sphere {<VM[i].x, VK[i].y+((alph/10)*VM[i].y)-3.95, VM[i].z> 0.01}
                        sphere { <VM[i].x, VK[i].y-((alph/10)*VM[i].y)+0.5, VM[i].z> 0.01}        
                        sphere { <VK[i].x, VK[i].y-1.9, VK[i].z> 0.01} 
                        texture{pigment{color rgbt<0.2,0.2,0.2,0.7>}  } rotate -x*90 translate -y*1.5
                }
        #end
#declare i=i+1; #end                     
